...
import styles from "../../components/ui/historia2/styles/Whatsapp.module.css";
...
export default function WhatsappPage() {
  ...
  const phoneNumber = searchParams.get('phone') || "59169452022"; // Usa parámetro o valor por defecto
