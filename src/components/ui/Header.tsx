          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-[240px] sm:w-[300px]">
              ...
              <nav className="flex flex-col gap-4 mt-6 p-6">
                ...
                <Link href="/historia1" className="text-sm font-medium">
                  Historia1
                </Link>
                <Link href="/historia2" className="text-sm font-medium">
                  Historia2
                </Link>
                <Link href="/historia3" className="text-sm font-medium">
                  Historia3
                </Link>
                <Link href="/historia4" className="text-sm font-medium">
                  Historia4
                </Link>
